...
Simply ask questions that match an agent's focus area, and Nano Code will automatically trigger the appropriate agent:
...
Nano Code may proactively use these agents based on context:
