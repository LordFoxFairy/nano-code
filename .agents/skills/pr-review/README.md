...
Simply ask questions that match an agent's focus area, and the agent will automatically trigger the appropriate specific agent:
...
The system may proactively use these agents based on context:
...
- User agents: `~/.nanocode/agents/`
- Project agents: `.nanocode/agents/` in nanocode-cli-internal
