...
Nano Code: Let me understand what you need...
...
- The assistant reads all identified files to build deep understanding
...
**Focus areas:**
- Project guideline compliance (NANO_CODE.md)
- Bug detection
- Code quality issues
