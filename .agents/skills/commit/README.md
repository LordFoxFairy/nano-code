...
- Includes NanoCode attribution in commit message
...
This plugin is included in the NanoCode repository. The commands are automatically available when using NanoCode.

## Best Practices

### Using `/commit`
- Review the staged changes before committing
- Let the agent analyze your changes and match your repo's commit style
...
- The agent will analyze the full branch history for the PR description
...
- **Let the agent draft messages**: The commit message analysis learns from your repo's style
