...
- Includes Nano Code attribution in commit message
...
This plugin is included in the Nano Code repository. The commands are automatically available when using Nano Code.

## Best Practices

### Using `/commit`
- Review the staged changes before committing
- Let Nano Code analyze your changes and match your repo's commit style
...
- Nano Code will analyze the full branch history for the PR description
...
- **Let Nano Code draft messages**: The commit message analysis learns from your repo's style
...
Nano Code Team (noreply@nanocode.dev)
